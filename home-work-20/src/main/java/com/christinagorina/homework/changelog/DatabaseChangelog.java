...
public class DatabaseChangelog {
    ...
    public void insertBooks(MongoDatabase db) {
        ...
        var book1 = Document.parse("{\"_id\":\"1\", \"name\":\"Love story\", \"genre\":\"Mystic\", \"authors\": [\"Orlov G. O.\"]}");
        var book2 = Document.parse("{\"_id\":\"2\", \"name\":\"Call of the night\", \"genre\":\"Fantastic\", \"authors\": [\"Somov E. V.\"]}");
        var book3 = Document.parse("{\"_id\":\"3\", \"name\":\"Close your eyes\", \"genre\":\"Horror\", \"authors\": [\"Levin O. F.\"]}");
        var book4 = Document.parse("{\"_id\":\"4\", \"name\":\"Bloodlust\", \"genre\":\"Drama\", \"authors\": [\"Emilov T. N.\"]}");
        bookList.add(book1);
        bookList.add(book2);
        bookList.add(book3);
        bookList.add(book4);
    ...
    public void insertGenre(MongoDatabase db) {
        ...
        var genre1 = Document.parse("{\"_id\":\"1\", \"name\":\"Mystic\", \"books\": [{\"name\": \"Love story\"}]}");
        var genre2 = Document.parse("{\"_id\":\"2\", \"name\":\"Fantastic\", \"books\": [{\"name\": \"Call of the night\"}]}");
        var genre3 = Document.parse("{\"_id\":\"3\", \"name\":\"Horror\", \"books\": [{\"name\": \"Close your eyes\"}]}");
        var genre4 = Document.parse("{\"_id\":\"4\", \"name\":\"Drama\", \"books\": [{\"name\": \"Bloodlust\"}]}");
