...
public class BookServiceImplTests {
    ...
    @Test
    void createBook() {
        BookTo actualBookTo = new BookTo(null, NEW_BOOK_NAME, Collections.singletonList(NEW_AUTHOR_NAME), NEW_GENRE_NAME, "user");
    ...
    void getByIdBook() {
        ...
        BookTo expectedBookTo = new BookTo(1L, BOOK_1_NAME, Collections.singletonList(AUTHOR_1_NAME), GENRE_1_NAME, "admin");
        assertThat(actualBookTo).usingRecursiveComparison().isEqualTo(expectedBookTo);
    }
